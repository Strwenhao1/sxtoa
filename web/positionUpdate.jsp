...
<body>
    ...
    <form action="positionController?method=updatePosition" method="post">

    <ul class="forminfo">
    <li><label>岗位编号</label><input name="posid" type="text" class="dfinput" readonly value="${position.posid}" /> </li>
