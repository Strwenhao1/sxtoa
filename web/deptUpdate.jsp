...
<body>
    ...
    <form action="deptController?method=updateDept" method="post">
    <ul class="forminfo">
    <li><label>部门编号</label><input name="deptno" type="text" class="dfinput" readonly = "readonly" value="${dept.deptno}"/> </li>
